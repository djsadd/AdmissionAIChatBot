...
async def ask_groq_category(query: str) -> str:
    try:
        chat_completion = client.chat.completions.create(
            messages=[
                {
                    ...
                    Твоя задача — обрабатывать входящие вопросы абитуриентов и возвращать КАТЕГОРИИ и все.
                    ...
                    7. Образовательные программы - Кафедры, наименование программ, Код, группа образовательных программ, академическая степень.
                    8. Общежитие - Адрес, стоимость, инсайты, условия проживания
                    9. Проходные баллы ЕНТ для бакалавриата после школы - в файле всего 3 специальности известно, остальные смотри в категории "Образовательные программы" - 7 пункт.
